...
class App
{
     ...
     */
    public static $pathToRoot = '/school_lessons';

    /**
     * @static
     * @var string Path to pChart classes
     */
    public static $pathToPCart = '/core/outsider/pChart2.1.4/';
     ...
     */
    public static $defaultTitle = 'Magic application';
     ...
     */
    const DB_DBNAME = 'school_lessons';
