...
class Route
{
    ...
    public static function start()
    {
        ...
        $controllerFile = $_SERVER{'DOCUMENT_ROOT'} . App::$pathToRoot
                          . str_replace('\\', '/', $controller) . ".php";
        ...
        if (file_exists($controllerFile)) {
            if (method_exists($controller, $action)) {
                ...
                GenerateException::getException('Route ' . $controller . ':::' . $action . ' wrong!');
            }
        } else {
            GenerateException::getException('In the route, file ' . $controllerFile . ' does not exists!');
        }
    }
